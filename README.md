...
[Day 6: Wait For It](https://adventofcode.com/2023/day/6) | [Python](python/06.py) | There must be some elementary math which reduces the time, but a) I just can't be bothered now; b) decided to just do what the puzzle title says.
